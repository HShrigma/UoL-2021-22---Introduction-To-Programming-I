...
Officer: 9737215
CaseNum: 402-2-29828361-9737215
...
function draw() {
	...
	///////////////////ADD YOUR CODE HERE///////////////////
	if (det.locationX > 700 && det.locationY <= 73) {
		det.speedX = -1;
		det.speedY = 0;
	}
	else if (det.locationX == 700 && det.locationY < 315) {
		det.speedX = 0;
		det.speedY = 1;
	}
	else if (det.locationX <= 700 && det.locationX > 380 && det.locationY == 315){
		det.speedX = -1;
		det.speedY = 0;
	}
	else if(det.locationX == 380 && det.locationY >= 315 && det.locationY < 450){
		det.speedX = 0;
		det.speedY = 1;
	}
	else if(det.locationX <= 380 && det.locationX > 190 && det.locationY >= 450){
		det.speedX = -1;
		det.speedY = 0;
	}
	else if(det.locationX == 190 && det.locationY < 640){
		det.speedX = 0;
		det.speedY = 1;
	}
	else if(det.locationY == 640 ){
		det.speedX = -1;
		det.speedY = 0;
	}
