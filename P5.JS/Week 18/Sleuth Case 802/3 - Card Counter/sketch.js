...
Officer: 9737215
CaseNum: 802-2-15782261-9737215

These sharks don’t mess about. One hand, winner takes all. 
What kind of chief would I be if I let you go in alone! I’ve counted the cards and I know what you need to win. 
Make sure you deal yourself the hand in hand_to_win from the deck and store it in the hand array.
...
*You also need to write a shuffleSeed() function. Same as before, it needs to return an array of 52 random integers but set the random value to start at 5 and end at 99.
...
var hand_to_win = [{"cardSuit":"Hearts","value":"Q"},{"cardSuit":"Hearts","value":"10"},{"cardSuit":"Clubs","value":"Q"},{"cardSuit":"Hearts","value":"J"},{"cardSuit":"Diamonds","value":"K"}];
var hand =[];
...
function winning_hand_set(){
	for(var i = 0; i < card_deck.length; i++){
		for(var j = 0; j < hand_to_win.length; j++){
			if(card_deck[i].number == hand_to_win[j].value && card_deck[i].s == hand_to_win[j].cardSuit){
